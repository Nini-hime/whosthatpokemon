export const TRANSLATIONS = {
  ...
  "de": {
    ...
    "on": "An",
    "off": "Aus",
    "streak": "Serie", // in German you can either use "Serie" as in "Siegesserie" (Winning Streak), or you can use "Lauf" but this is normally only used within a sentence "Ich habe einen Lauf" (I have a streak) an not as single word
    "time": "Zeit",
    "best": "Beste",
    "current": "Aktuelle",
    "previous": "Vorherige",
    ...
    "nextpokemon": "Nächstes Pokémon in _TIME_ Sekunden",
    "loadfail": 'Das braucht aber lange zum Laden.. <a href="#" id="loadNewPokemonCta">Versuch doch ein anderes Pokémon zu laden. Es wird deine Serie nicht beeinflussen,</a>?',
    "slowconn": "Ist deine Verbindung langsam? Versuche doch eine höhere Schwierigkeitsstufe, diese laden schneller.",
    "loadnew": "Eine neues Pokémon laden?",
    "streak-info": "Deine Bestzeiten und -serie sind für jeden Schwierigkeitsgrad separat",
    "settings-effect": "Die neuen Einstellungen werden ab dem nächsten Pokémon übernommen",
    "genfinished": "Es gibt keine Pokémon mehr! Versuche es mit einer anderen Generation oder Schwierigkeit. Gen 8 und 9 unterstützen nicht die Schwierigkeitsgrade Hyper und Meister, da diese Spiele keine Sprites haben.",
    "infobox": 'NEU: Generation 9 hinzugefügt! Da Pokémon seit Gen 8 keine Sprites haben, werden nur die Schwierigkeitsstufen Einfach, Normal und Elite unterstützt. Wenn du Probleme oder Fehler findest, gib mir auf GitHub bescheid!',
    "footer": 'Lass Feedback da oder hilf mit auf <a href="https://github.com/Menardi/whosthatpokemon" title="Who\'s That Pokémon à Github">Github</a>.<br />Bilder und Töne beigetragen von <a href="https://github.com/sora10pls">sora10pls</a>. Bilder und Töne &copy; Nintendo.',
    "language": 'Sprache',
    "settings": 'Optionen',
    "stats": 'Statistik',
  },
